...
export const ourTeamImages: { [id: string]: string } = {
  prakash_ahuja_img: prakash_ahuja_img,
  ibrahim_somji_img: ibrahim_somji_img,
  amjad_ali_img: amjad_ali_img,
  vijay_ahuja_img: vijay_ahuja_img,
  jay_ahuja_img: jay_ahuja_img,
};
