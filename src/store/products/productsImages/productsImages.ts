import A1A2_Cable_Gland from "./a1-a2-cable-gland.jpg";
import A1A2_Cable_Glands from "./a2-cable-glands.jpg";
import BW_Cable_Gland from "./bw-cable-gland.jpg";
import BW_Cable_Glands from "./bw-cable-gland1.jpg";
import CW_Cable_Gland from "./cw-cable-glands.jpg";
import CW_Cable_Glands from "./cw-cable-glands1.jpg";
import E1W_Cable_Gland from "./cw-cable-glands.jpg";
import E1W_Cable_Glands from "./cw-cable-glands1.jpg";
import Armoured_Cables from "./armoured-cables.jpg";
import Control_Cables from "./control-cables.jpg";
import Multi_Conductor from "./multi-conductor-sheilded-cables.jpg";
import Rubber_Cable from "./rubber-cables-ho7rnf.jpg";
import Panel_Wire from "./panel-wire.jpg";
import PVC_Flexible_Wire from "./pvc-flexible-wire.jpg";
import Building_Wire from "./building-wire.jpg";
import M_LV_Resin_Joint_Kit from "./3M-LV-Resin-Joint-Kit-technical.jpg";
import LV_3M_Cold_Shrink_Straight_Cable_Joint from "./lv-3m-cold-shrink-straight-cable-joints.jpg";
import Heat_Shrink_Termination from "./heat-shrink-terminal.jpg";
import M_Wire_Pulling_Lubricant from "./3m-wire-pulling-lubricant.jpg";
import Cold_Shrink_Termination from "./cold-shrink-termination.jpg";
...
export const productsImages: { [id: string]: string } = {
  ...
  A1A2_Cable_Glands: A1A2_Cable_Glands,
  BW_Cable_Gland: BW_Cable_Gland,
  BW_Cable_Glands: BW_Cable_Glands,
  Armoured_Cables: Armoured_Cables,
  Control_Cables: Control_Cables,
  Multi_Conductor: Multi_Conductor,
  Rubber_Cable: Rubber_Cable,
  CW_Cable_Gland: CW_Cable_Gland,
  CW_Cable_Glands: CW_Cable_Glands,
  E1W_Cable_Gland: E1W_Cable_Gland,
  E1W_Cable_Glands: E1W_Cable_Glands,
  Panel_Wire: Panel_Wire,
  PVC_Flexible_Wire: PVC_Flexible_Wire,
  Building_Wire: Building_Wire,
  M_LV_Resin_Joint_Kit: M_LV_Resin_Joint_Kit,
  Heat_Shrink_Termination: Heat_Shrink_Termination,
  LV_3M_Cold_Shrink_Straight_Cable_Joint:
    LV_3M_Cold_Shrink_Straight_Cable_Joint,
  M_Wire_Pulling_Lubricant: M_Wire_Pulling_Lubricant,
  Cold_Shrink_Termination: Cold_Shrink_Termination,
